...
export function RoleSwitcher() {
  ...
  return (
    <label className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-gray-50 px-2 py-1 text-xs text-gray-600">
      ...
      <select
        ...
        className="max-w-32 bg-transparent text-xs font-semibold text-gray-900 outline-none xl:max-w-44"
      >
